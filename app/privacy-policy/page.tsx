...
export const metadata: Metadata = buildMetadata({
  title: "Privacy Policy & SMS Terms | Face Down Recovery Rentals",
  description:
    "Privacy Policy and SMS Terms of Service for Face Down Recovery Rentals, including customer information use and text messaging consent terms.",
  path: "/privacy-policy",
});
        ...
        <div className="mx-auto max-w-4xl space-y-12 font-sans text-lg leading-8 text-neutral-900">
          <article>
            ...
            <div className="mt-6 space-y-5">
              <p>
                FDR Rentals LLC (&quot;Face Down Recovery Rentals&quot;) respects your privacy. We collect information
              ...
              <p>
                ...
                <a className="text-teal-700 underline underline-offset-4" href="mailto:info@fdrrentals.com">
                  info@fdrrentals.com
                </a>{" "}
                or{" "}
                <a className="text-teal-700 underline underline-offset-4" href="tel:+14693001867">
                  (469) 300-1867
                </a>
                .
              </p>
          ...
          <article>
            ...
            <div className="mt-6 space-y-5">
              <p>
                By opting into SMS communications from Face Down Recovery Rentals, you agree to receive text messages
              ...
              <p>FDR Rentals LLC reserves the right to update these terms at any time.</p>
            </div>
          </article>
        </div>
      </section>
